...
xml.feed('xml:lang' => 'en-US', 'xmlns' => 'http://www.w3.org/2005/Atom') do
  ...
  xml.link(rel: 'alternate', type: 'text/html', href: 'https://blog.simplegolftour.com')
  xml.link(rel: 'self', type: 'application/atom+xml', href: 'https://blog.simplegolftour.com/feed')
  ...
  @posts.each do |post|
    xml.entry do
      ...
      xml.link rel: 'alternate', type: 'text/html', href: "https://blog.simplegolftour.com/#{post.slug}"
